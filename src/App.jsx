...
const APP_PASSWORD = 'nami-240926-@';
const AUTH_STORAGE_KEY = 'qr-generator-auth';
        ...
        return (
            <Container className='auth-container'>
                <Card className='auth-card'>
                    <Card.Body>
                        <Card.Title className='mb-4'>QR Generator</Card.Title>
                ...
                <Form>
                        ...
                        <Col md={6}>
                            <Form.Group>
                                ...
                                <Form.Text className='text-muted'>
                                    Max {maxCardsPerSheet} pcs per A4 sheet for
                                    this item
                                </Form.Text>
                            </Form.Group>
                        </Col>
                    ...
                    <div className='d-flex justify-content-end gap-3 mt-4'>
                        ...
                        <Button
                            ...
                            title={
                                downloadPackage
                                    ? 'Download the generated PNG/ZIP'
                                    : 'Generate the codes first'
                            }
                        >
                ...
                <div className='mt-5'>
                    <div className='d-flex justify-content-between align-items-center mb-2'>
                        ...
                        <span className='badge bg-primary'>
                            ...
                            {generatedFiles.length > 1 ? 'items' : 'item'}
                        </span>
                    </div>
                    <p className='text-muted mb-4'>
                        To print, press <strong>Ctrl+P</strong> (⌘+P on Mac) —
                        only the cards below will be printed.
                    </p>
                    <CardsSheet
                        prefix={generatedPrefix}
                        cards={generatedFiles}
                    />
                </div>
            )}
        </Container>
